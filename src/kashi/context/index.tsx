...
import { ChainId, Currency, WETH } from '@aceswap/sdk'
import { bentobox } from '@aceswap/ace-data'
...
interface State {
    info:
        | {
              ...
              aceBalance: BigNumber
              aceBarBalance: BigNumber
              xsushiBalance: BigNumber
              xsushiSupply: BigNumber
              aceBarAllowance: BigNumber
              factories: {}[]
              ethRate: BigNumber
              aceRate: BigNumber
              btcRate: BigNumber
              pendingAce: BigNumber
...
export function KashiProvider({ children }: { children: JSX.Element }) {
    ...
    const updatePairs = useCallback(
        async function() {
            ...
            try {
                if (boringHelperContract && bentoBoxContract && KASHI_ADDRESS[chainId]) {
