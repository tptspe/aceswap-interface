import { ChainId, JSBI, Percent, Token, WETH } from '@aceswap/sdk'
...
// ACE
export const ACE: ChainTokenMap = {
...
export const ANALYTICS_URL: { [chainId in ChainId]?: string } = {
    [ChainId.MAINNET]: 'https://analytics.aceswap.finance',
    [ChainId.MATIC]: 'https://analytics.aceswap.finance',
    [ChainId.FANTOM]: 'https://analytics.aceswap.finance',
    [ChainId.BSC]: 'https://analytics.aceswap.finance',
    [ChainId.XDAI]: 'https://analytics.aceswap.finance'
}
