...
function Web3Network(): JSX.Element | null {
    ...
    return (
        ...
        >
            <div className="grid grid-flow-col auto-cols-max items-center rounded-lg  bg-transparent   text-sm text-secondary py-2 px-3 pointer-events-auto">
                <img
                ...
                />
                <div className="text-secondary hover:text-black">{NETWORK_LABEL[chainId]}</div>
            </div>
            {/* <div
