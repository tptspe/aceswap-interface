...
import { ChainId, Currency, currencyEquals, ETHER, Percent, WETH } from '@aceswap/sdk'
            ...
            <>
                <RowBetween>
                    <Text color={theme.text2} fontWeight={500} fontSize={16}>
                        {'ACE ' + currencyA?.getSymbol(chainId) + '/' + currencyB?.getSymbol(chainId)} Burned
                    </Text>
                    <RowFixed>
