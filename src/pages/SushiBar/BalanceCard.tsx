...
export default function BalanceCard({
    ...
    return (
        <div className="flex flex-col w-full bg-gray-200 rounded px-4 md:px-8 pt-6 pb-5 md:pt-7 md:pb-9">
            <div className="flex flex-wrap">
                <div className="flex flex-col flex-grow md:mb-14">
                    <p className="mb-3 text-lg font-bold md:text-h5 md:font-medium text-black">Balance</p>
                    <div className="flex items-center">
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <p className="text-black">xSUSHI</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                    <div className="flex flex-nowrap mb-3 ml-8 md:ml-0">
                        <p className="text-lg font-bold md:text-h5 md:font-medium text-black">Unstaked</p>
                    ...
                    <div className="flex items-center ml-8 md:ml-0">
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <p className="text-black">SUSHI</p>
                        </div>
                    </div>
                </div>
