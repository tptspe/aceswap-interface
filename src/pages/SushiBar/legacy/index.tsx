...
export default function SushiBar() {
    ...
    return (
        <>
            <Helmet>
                <title>Ace Bar | Ace</title>
                <meta
                    name="description"
                    content="Exchange SUSHI for xSUSHI to enter the bar and gain a revenue share (0.05%) of income generated by the platform of Ace products. "
                />
            </Helmet>
